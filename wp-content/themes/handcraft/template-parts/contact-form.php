<?php
$post_id = get_the_id();
$custom_form_switch = get_post_meta($post_id, 'custom_form_switch', true);
$custom_form_embed = get_post_meta($post_id, 'custom_form_embed', true);
?> 

<div class="text-center contact-form-box ">
                    ...
                    <?php if ($custom_form_switch != 'on') : ?>
                        <form id="booking_form" class="form text-left" role="form">
                            <fieldset>
                                ...
                                $label_1 = (isset($label_1) && strlen($label_1)) ? $label_1 : __("Name", "handcraft");
                                ?>
                            ...
                            <fieldset>
                                ...
                                $label_2 = (isset($label_2) && strlen($label_2)) ? $label_2 : __("Email", "handcraft");
                                ?>
                            ...
                            <fieldset>
                                ...
                                $label_3 = (isset($label_3) && strlen($label_3)) ? $label_3 : __("Message", "handcraft");
                                ?>
                            ...
                            <fieldset>
                                ...
                                <input type="submit" class="submit button small-button round pull-right" value="<?php echo ((isset($label_4) && strlen($label_4)) ? $label_4 : __('SUBMIT', 'handcraft')); ?>" name="booking-submit" />
                            </fieldset>
                            <fieldset>
